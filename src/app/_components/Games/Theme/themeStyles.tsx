...
export const themeStyles: Record<ThemeName, ThemeStyle> = {
    ...
    PIGGY: {
        ...
        // backgroundColor: "bg-[#f9dcc4]", E78EA9
        backgroundColor: "bg-[#E78EA9]",
        border: "border-[#ffff]",
