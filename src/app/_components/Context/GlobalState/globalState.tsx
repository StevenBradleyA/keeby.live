...
const GlobalStateProvider: React.FC<ThemeProviderProps> = ({ children }) => {
    ...
    }, [hasProfile, pathname, session, showCookieBanner]);
            ...
            <ModalDialog isOpen={isModalOpen} onClose={closeModal}>
                <div className="flex flex-col items-center text-sm">
                    ...
                    <p className="mt-3 w-80 text-sm ">
                        Keeby uses cookies to remember your active settings and
                        keep you signed in to provide a better overall
                        experience.
                    </p>
                    <Link
                        href="/cookie-policy"
                    ...
                    >
                        ...
                        <span className="profile-manage-button-text">Okay</span>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="currentColor"
