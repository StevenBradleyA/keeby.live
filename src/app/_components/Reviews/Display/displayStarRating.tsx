...
export default function DisplayStarRating({ rating }: SellerStarRatingProps) {
    const getStarFill = (starIndex: number) => {
        if (!rating) return { offset: 0, color: "#616161" };

        const averageRating = Math.round(rating * 10) / 10;
