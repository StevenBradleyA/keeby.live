...
export default function PrivacyPolicy() {
    ...
    return (
        <>
            <h1 className="flex justify-center text-5xl text-green-500 w-full mt-40 ">
                Privacy Policy
            </h1>
            <div className="w-full flex flex-col items-center text-white/40">
                <div className="w-1/2">
                    ...
                    <p className="mb-5 rounded-md bg-keebyGray p-5  ">
                        ...
                        All payment transactions are conducted through our
                        third-party payment processor, PayPal, which uses its
                        own secure and encrypted channels.
                    </p>
                    <h2 className="mb-5 text-4xl text-green-500 ">
                    ...
                    <p className="mb-5 rounded-md bg-keebyGray p-5  ">
                        ...
                        such as processing transactions via PayPal, providing
                    ...
                    <p className="mb-5 rounded-md bg-keebyGray p-5  ">
                        ...
                        nature. When you create an account, your username and
                        any content you post under that account will be visible
                        to other users of the Website. Additionally,
                        participating in our typing games may result in your
                        game results, including scores and rankings, being
