...
export default function NotFound() {
    ...
    return (
        <>
            <div className=" fixed top-0 left-0 right-0 bottom-0 text-white space-gradient">
                <div className="relative z-10 h-[88vh] w-full overflow-hidden mt-40">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="absolute left-1/2 top-0 h-[500px] w-[500px] -translate-x-1/2 z-40"
                        version="1.1"
                        viewBox="0 0 512 512"
                    >
                        <g>
                    ...
                    <div className="absolute left-[25%] top-[300px] z-50 w-[500px]  overflow-hidden rounded-xl border-[1px] border-black font-retro text-black">
                        <div className="flex h-10 w-full justify-between rounded-t-xl border-b-[1px] border-black bg-[#FBC1CC] px-4 py-2">
                            ...
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor"
                                className="h-5 w-5 border-[1px] border-black bg-gray-100 p-[3px] text-black hover:brightness-95"
                                viewBox="0 0 16 16"
                            >
                        ...
                        <div className="bg-gray-100 p-9 ">
                            ...
                            <div className="mt-5 flex justify-center gap-10">
                                <Link
                                    className="border border-gray-400 border-l-gray-100 border-t-gray-100 bg-gray-200 hover:brightness-95 px-4 py-2 text-black shadow-inner active:border-b-gray-400 active:border-l-gray-200 active:border-r-gray-400 active:border-t-gray-200"
                                    href={"/"}
                                    aria-label="home"
                                >
                                    Yes, Please
