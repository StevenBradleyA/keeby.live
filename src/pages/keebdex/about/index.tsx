...
export default function KeebyAbout() {
    return (
        <>
            <div>
                I Love mechanical keyboards and wanted to create an awesome site
                to share the hobby with others. Keeby is the one place for
                everything mechanical keyboard. A marketplace to buy and sell
