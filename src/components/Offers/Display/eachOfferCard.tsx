    ...
    return (
        <>
            {listing.listingOffer.map((offer, index) => (
                <div
                    key={index}
                    className="flex h-[25vh] w-96 flex-col gap-5 overflow-hidden rounded-2xl bg-keebyGray p-3 font-poppins text-darkGray "
                >
                    ...
                    <div className="flex justify-center gap-10">
                        ...
                        <button className=" text-md keeb-shop-offer-button mt-5 flex items-center gap-2 rounded-md bg-green-500 py-2 pr-4 text-black ">
                            {" "}
                            <svg
