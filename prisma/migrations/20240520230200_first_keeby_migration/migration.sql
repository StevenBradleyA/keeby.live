...
CREATE TABLE "VerificationTransaction" (
    ...
    CONSTRAINT "VerificationTransaction_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Message" ADD CONSTRAINT "Message_listingTransactionId_fkey" FOREIGN KEY ("listingTransactionId") REFERENCES "ListingTransaction"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "VerificationTransaction" ADD CONSTRAINT "VerificationTransaction_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
